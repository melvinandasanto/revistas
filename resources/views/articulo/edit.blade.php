        ...
        <div class="card">
            <div class="card-header bg-warning">
                <h2 class="card-title mb-0 text-white">
                    <i class="bi bi-pencil"></i> Editar Artículo
                </h2>
            </div>
            ...
            <div class="card-body">
                <form action="/articulo/{{$articuloE->id}}" method="POST" id="articuloForm">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="search-container">
                                ...
                                <input type="text" name="id" id="id" class="form-control search-input" value="{{$articuloE->id}}" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="search-container">
                        ...
                        <input type="text" id="revista_search" class="form-control search-input" placeholder="Buscar revista por título..." 
                            ...
                            @foreach($asignaciones as $index => $asignacion)
                                <div class="autor-item">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <label class="form-label mb-0"><strong>Autor {{ $index + 1 }}</strong></label>
                                        @if($index > 0)
                                    ...
                                    <input type="text" class="autor-search form-control search-input mb-2" placeholder="Buscar autor por nombre..." 
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-outline-warning">
                            <i class="bi bi-check2"></i> Actualizar Artículo
                        </button>
                    </div>
                </form>
            </div>
