        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-warning">
                    <strong><i class="bi bi-exclamation-triangle"></i> Advertencia:</strong> Esta acción eliminará al autor de la base de datos de forma permanente.
                </div>
            ...
            <div class="card-footer">
                <form action="/autor/{{$autorE->id}}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
